...
package com.mobileman.kuravis.core.services.option_list.unit.impl;
 ...
 */
@Service
public class UnitServiceImpl extends OptionListServiceImpl<Unit> implements UnitService {
	...
	/** 
	 * {@inheritDoc}
	 * @see com.mobileman.kuravis.core.services.entity.impl.AbstractEntityServiceImpl#findAll()
	 */
	@Override
	@Cacheable(Unit.ENTITY_NAME)
	 ...
	 */
	@CacheEvict(value=Unit.ENTITY_NAME, key="#object.get(\"_id\")", allEntries=false)
	@Override
	 ...
	 */
	@CacheEvict(value=Unit.ENTITY_NAME, key="#object.get_id()", allEntries=false)
	@Override
	public String save(Unit object) {
		return super.save(object);
	}
	...
	public boolean isRefernced(String id) {
		...
		Query query = Query.query(Criteria.where(TreatmentEvent.UNIT + "." + TreatmentEvent.ID).is(id));

...
package com.mobileman.kuravis.core.services.option_list.psychotherapy.impl;
 ...
 */
@Service
public class PsychotherapyServiceImpl extends OptionListServiceImpl<Psychotherapy> implements PsychotherapyService {
	 ...
	 */
	@Override
	@Cacheable(Psychotherapy.ENTITY_NAME)
	 ...
	 */
	@CacheEvict(value=Psychotherapy.ENTITY_NAME, key="#object.get(\"_id\")", allEntries=false)
	@Override
	 ...
	 */
	@CacheEvict(value=Psychotherapy.ENTITY_NAME, key="#id", allEntries=false)
	@Override
	 ...
	 */
	@CacheEvict(value=Psychotherapy.ENTITY_NAME, key="#object.get(\"_id\")", allEntries=true)
	@Override
	 ...
	 */
	@CacheEvict(value=Psychotherapy.ENTITY_NAME, key="#object.get_id()", allEntries=true)
	@Override
	public String save(Psychotherapy object) {
		return super.save(object);
	}
